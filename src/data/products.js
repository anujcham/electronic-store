...
export const products = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "Flawless condition! Battery came in at 97% health and not a single scratch on the titanium frame. Fast Royal Mail delivery too.",
      ...
      },
      {
        ...
        rating: 5,
        comment: "Upgraded from an iPhone 12. The camera zoom and screen brightness are sensational. Looks and feels completely brand new.",
      ...
      },
      {
        userName: "David M.",
        rating: 4,
        comment: "Great handset and swift dispatch. USB-C braided cable included in the box. Very satisfied with ElectroVault.",
  ...
  buildProduct({
    ...
    price: 799,
    originalPrice: 999,
    condition: PRODUCT_CONDITIONS.LIKE_NEW,shortDescription: "Compact 6.1-inch titanium flagship with A17 Pro performance, Action button, and 48MP Pro camera.",
    description:
  ...
  buildProduct({
    ...
    price: 579,
    originalPrice: 799,
    condition: PRODUCT_CONDITIONS.EXCELLENT,shortDescription: "Color-infused back glass iPhone 15 with Dynamic Island, 48MP main camera, and USB-C connectivity.",
    description:
  ...
  buildProduct({
    ...
    price: 549,
    originalPrice: 899,
    condition: PRODUCT_CONDITIONS.EXCELLENT,shortDescription: "Pro camera system with Dynamic Island, Always-On display, and durable surgical stainless steel frame.",
    description:
  ...
  buildProduct({
    ...
    price: 429,
    originalPrice: 699,
    condition: PRODUCT_CONDITIONS.GOOD,shortDescription: "Best-value refurbished iPhone 13 with super-bright OLED display, Cinematic mode, and all-day battery.",
    description:
  ...
  buildProduct({
    ...
    price: 289,
    originalPrice: 499,
    condition: PRODUCT_CONDITIONS.VERY_GOOD,shortDescription: "Ultra-affordable 5G iPhone with flat aerospace-aluminum edges and crisp OLED display.",
    description:
  ...
  buildProduct({
    ...
    price: 219,
    originalPrice: 429,
    condition: PRODUCT_CONDITIONS.GOOD,shortDescription: "Compact classic iPhone with fast A15 Bionic chip and reliable Touch ID fingerprint sensor.",
    description:
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "The titanium frame and flat display are magnificent. S-Pen works flawlessly and battery life easily lasts 2 full days.",
      ...
      },
      {
        ...
        rating: 5,
        comment: "Saved over £300 compared to buying brand new retail. Diagnostic cert was included in the box showing 100% check pass.",
        createdAt: "2025-02-02T11:10:00.000Z",
        verifiedPurchase: true,
      },
    ],
  ...
  buildProduct({
    ...
    price: 549,
    originalPrice: 799,
    condition: PRODUCT_CONDITIONS.LIKE_NEW,shortDescription: "Compact 6.2-inch flagship with Galaxy AI, vibrant 120Hz Dynamic AMOLED, and all-day battery life.",
    description:
  ...
  buildProduct({
    ...
    price: 619,
    originalPrice: 1149,
    condition: PRODUCT_CONDITIONS.EXCELLENT,shortDescription: "Flagship 200MP camera system with 100x Space Zoom, built-in S Pen, and long-lasting 5,000 mAh battery.",
    description:
  ...
  buildProduct({
    ...
    price: 529,
    originalPrice: 999,
    condition: PRODUCT_CONDITIONS.EXCELLENT,shortDescription: "Iconic foldable phone featuring expanded 3.4-inch Flex Window cover screen and zero-gap hinge.",
    description:
  ...
  buildProduct({
    ...
    price: 549,
    originalPrice: 999,
    condition: PRODUCT_CONDITIONS.EXCELLENT,shortDescription: "Pro AI camera handset with Google Tensor G3 chip, temperature sensor, and bright Super Actua display.",
    description:
  ...
  buildProduct({
    ...
    price: 439,
    originalPrice: 699,
    condition: PRODUCT_CONDITIONS.LIKE_NEW,shortDescription: "Compact AI smartphone with brilliant 120Hz Actua display, Tensor G3, and extraordinary camera smarts.",
    description:
  ...
  buildProduct({
    ...
    price: 599,
    originalPrice: 849,
    condition: PRODUCT_CONDITIONS.LIKE_NEW,shortDescription: "Extreme speed phone with 100W SUPERVOOC charging, 5400mAh battery, and 4th Gen Hasselblad camera.",
    description:
  ...
  buildProduct({
    ...
    price: 649,
    originalPrice: 899,
    condition: PRODUCT_CONDITIONS.LIKE_NEW,shortDescription: "Astonishing performance with Apple M2 chip, 120Hz ProMotion Liquid Retina display, and Apple Pencil hover.",
    description:
  ...
  buildProduct({
    ...
    price: 449,
    originalPrice: 649,
    condition: PRODUCT_CONDITIONS.EXCELLENT,shortDescription: "Ultra-portable iPad Air with desktop-class Apple M1 performance, 10.9-inch Liquid Retina, and Touch ID.",
    description:
  ...
  buildProduct({
    ...
    price: 799,
    originalPrice: 1099,
    condition: PRODUCT_CONDITIONS.LIKE_NEW,shortDescription: "Strikingly thin aluminum unibody MacBook Air with M2 speed, MagSafe charging, and silent fanless design.",
    description:
  ...
  buildProduct({
    ...
    price: 329,
    originalPrice: 499,
    condition: PRODUCT_CONDITIONS.LIKE_NEW,shortDescription: "Advanced smartwatch with Double Tap gesture, brighter Always-On display, and independent cellular connectivity.",
    description:
  ...
  buildProduct({
    ...
    price: 259,
    originalPrice: 380,
    condition: PRODUCT_CONDITIONS.LIKE_NEW,shortDescription: "Industry-leading noise cancelling with Auto NC Optimizer, 30-hour battery life, and ultra-comfortable fit.",
    description:
